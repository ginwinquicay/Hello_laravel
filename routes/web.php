...
Route::middleware('auth:admin')->group(function () {
    ...
    // Customer management
    Route::get('/admin/customers', [SystemAdminController::class, 'listCustomers'])->name('admin.customers');
    Route::get('/admin/customers/create', [SystemAdminController::class, 'createCustomer'])->name('admin.customers.create');
    Route::post('/admin/customers/store', [SystemAdminController::class, 'storeCustomer'])->name('admin.customers.store');
    Route::get('/admin/customers/{id}/edit', [SystemAdminController::class, 'editCustomer'])->name('admin.customers.edit');
    Route::put('/admin/customers/{id}', [SystemAdminController::class, 'updateCustomer'])->name('admin.customers.update');
    Route::delete('/admin/customers/{id}', [SystemAdminController::class, 'deleteCustomer'])->name('admin.customers.delete');

    // Staff management
    Route::get('/admin/staff', [SystemAdminController::class, 'listStaff'])->name('admin.staff');
    Route::get('/admin/staff/create', [SystemAdminController::class, 'createStaff'])->name('admin.staff.create');
    Route::post('/admin/staff/store', [SystemAdminController::class, 'storeStaff'])->name('admin.staff.store');
    Route::get('/admin/staff/{id}/edit', [SystemAdminController::class, 'editStaff'])->name('admin.staff.edit');
    Route::put('/admin/staff/{id}', [SystemAdminController::class, 'updateStaff'])->name('admin.staff.update');
    Route::delete('/admin/staff/{id}', [SystemAdminController::class, 'deleteStaff'])->name('admin.staff.delete');

    // Submission categories & priorities
    Route::get('/admin/categories', [SystemAdminController::class, 'listCategories'])->name('admin.categories');
    Route::get('/admin/categories/create', [SystemAdminController::class, 'createCategory'])->name('admin.categories.create');
    Route::post('/admin/categories/store', [SystemAdminController::class, 'storeCategory'])->name('admin.categories.store');
    Route::get('/admin/categories/{id}/edit', [SystemAdminController::class, 'editCategory'])->name('admin.categories.edit');
    Route::put('/admin/categories/{id}', [SystemAdminController::class, 'updateCategory'])->name('admin.categories.update');
    Route::delete('/admin/categories/{id}', [SystemAdminController::class, 'deleteCategory'])->name('admin.categories.delete');

    Route::get('/admin/priorities', [SystemAdminController::class, 'listPriorities'])->name('admin.priorities');
    Route::get('/admin/priorities/create', [SystemAdminController::class, 'createPriority'])->name('admin.priorities.create');
    Route::post('/admin/priorities/store', [SystemAdminController::class, 'storePriority'])->name('admin.priorities.store');
    Route::get('/admin/priorities/{id}/edit', [SystemAdminController::class, 'editPriority'])->name('admin.priorities.edit');
    Route::put('/admin/priorities/{id}', [SystemAdminController::class, 'updatePriority'])->name('admin.priorities.update');
