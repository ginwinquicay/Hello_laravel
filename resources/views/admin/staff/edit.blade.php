...
<div class="container py-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h2 class="text-primary">Edit Staff</h2>
  ...
  <div class="card card-custom p-4">
    ...
    <form action="{{ route('admin.staff.update', $staff->StaffID) }}" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="Fname" name="Fname" value="{{ old('Fname', $staff->Fname) }}" required>
      </div>

      <div class="mb-3">
        <label for="Lname" class="form-label">Last Name</label>
        <input type="text" class="form-control" id="Lname" name="Lname" value="{{ old('Lname', $staff->Lname) }}" required>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="contact_no" name="contact_no" value="{{ old('contact_no', $staff->contact_no) }}" required>
      </div>

      <button type="submit" class="btn btn-dashboard">Update Staff</button>
    </form>
  </div>
