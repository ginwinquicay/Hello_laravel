...
<head>
  ...
  <title>Create Priority Level</title>
...
<div class="container py-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h2 class="text-primary">Create New Priority</h2>
  ...
  <div class="card card-custom p-4">
    ...
    <form action="{{ route('admin.priorities.store') }}" method="POST">
      @csrf
      <div class="mb-3">
        <label for="responsetime" class="form-label">Priority Name</label>
        <input type="text" class="form-control" id="priorityname" name="priorityname" value="{{ old('priorityname') }}" required>
      </div>

      <div class="mb-3">
        <label for="responsetime" class="form-label">Response Time</label>
        <input type="text" class="form-control" id="responsetime" name="responsetime" value="{{ old('responsetime') }}" required>
      </div>
