...
<div class="container py-4">
  ...
  <div class="mb-4">
    ...
    <a href="{{ route('admin.customers') }}" class="btn btn-dashboard mt-2">Back to Customers List</a>
  </div>
  ...
  <div class="card card-custom p-4">
    <form action="{{ route('admin.customers.update', $customer->CustomerID) }}" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="contact_no" name="contact_no" value="{{ old('contact_no', $customer->contact_no) }}" required>
      </div>
      ...
      <button type="submit" class="btn btn-dashboard">Update Customer</button>
    </form>
  </div>
