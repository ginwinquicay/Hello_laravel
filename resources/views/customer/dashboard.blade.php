...
<div class="container py-4">
  ...
  <div class="card card-custom mb-4 p-4">
    ...
    <p>
      This is your personalized dashboard. From here, you can manage your submissions,
      update your profile, and view your submission history.
    </p>
    <a href="{{ url('/customer/feedback') }}" class="btn btn-feedback">
      Submit Feedback
    </a>
  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex flex-column flex-sm-row gap-1">
                    ...
                    <a
                      href="{{ route('submission.edit', $submission->SubmissionID) }}"
                      class="btn btn-sm btn-primary
                        @if($submission->status === 'Closed') disabled bg-secondary border-secondary @endif"
                    ...
                    <form
                      action="{{ route('submission.destroy', $submission->SubmissionID) }}"
                      method="POST"
                      class="d-inline"
                    >
                      @csrf
                    ...
                    <button
                      ...
                      data-bs-target="#comments-{{ $submission->SubmissionID }}"
                      aria-expanded="false"
                      ...
                      @forelse($submission->comments as $comment)
                        <div class="border rounded p-2 mb-1">
                          ...
                          @if($comment->action_taken)
                            <div>
                              <em>Action taken: {{ $comment->action_taken }}</em>
                            </div>
                          @endif
