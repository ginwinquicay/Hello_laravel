    ...
    <div class="row">
      ...
      <div class="col-md-3 col-lg-2 sidebar p-3">
        <nav class="nav flex-column">
          <a href="#" class="nav-link py-2 px-3 mb-1">Profile</a>
          <a href="#" class="nav-link py-2 px-3 mb-1">Settings</a>
          <a href="#" class="nav-link py-2 px-3 mb-1">Support</a>
        </nav>
      </div>
      ...
      <div class="col-md-9 col-lg-10 p-4">
        ...
        <div class="card card-custom mb-4 p-4">
          ...
          <div class="d-flex gap-3">
            <a href="{{ url('/customer/feedback') }}" class="btn btn-feedback fw-semibold">
              Submit a Feedback
            </a>
          </div>
        </div>
